    ...
    <div className="bg-bg">
      ...
      <div className="relative bg-night overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[640px] px-5 md:px-8 pt-10 pb-10 md:pt-14 md:pb-12">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-x-2 gap-y-2">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/25 mr-0.5">Share</span>
            {[
              ...
              <button key={label} onClick={action}
                className="flex items-center gap-1.5 h-9 px-3.5 rounded-full border border-white/10 bg-white/[0.06] text-white/55 hover:text-white text-[11px] font-semibold transition-all">
                {icon} {label}
              </button>
            ))}
          </div>
      ...
      {isGuest ? (
        ...
        <div className="bg-bg border-t border-border/40">
          <div className="mx-auto max-w-[640px] px-4 sm:px-8 py-5 sm:py-8">
            <div className="flex flex-col sm:flex-row gap-3">
              <button onClick={() => navigate("/assess")} className="w-full sm:flex-1 h-12 flex items-center justify-center rounded-full ring-1 ring-border text-sm font-semibold text-fg hover:bg-surface-2 transition-colors px-4">Take another assessment</button>
              <button onClick={() => navigate("/dashboard")} className="w-full sm:flex-1 h-12 flex items-center justify-center rounded-full font-semibold text-sm text-white transition-all hover:opacity-90 shadow-lift px-4" style={{ background: tone.hex }}>Go to dashboard →</button>
            </div>
          </div>
        </div>
      )}
    ...
    <div className="rounded-[1.5rem] border border-border/60 bg-surface overflow-hidden">
      ...
      <div className="p-5">
        ...
        <button onClick={onUnlock}
          className="mt-4 w-full h-auto min-h-[3rem] px-4 py-3 flex items-center justify-center rounded-full font-semibold text-sm text-white transition-all hover:opacity-90 text-center leading-snug"
